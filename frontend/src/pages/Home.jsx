...
import { FaDumbbell, FaUsers, FaCalendar, FaHeart, FaClock, FaStar, FaArrowRight, FaCheck, FaQuoteLeft, FaPlay } from 'react-icons/fa';
...
const Home = () => {
  ...
  const stats = [
    { icon: <FaUsers className="text-3xl text-primary" />, value: '500+', label: 'Happy Members' },
    { icon: <FaDumbbell className="text-3xl text-primary" />, value: '20+', label: 'Expert Trainers' },
    { icon: <FaCalendar className="text-3xl text-primary" />, value: '50+', label: 'Weekly Classes' },
    { icon: <FaHeart className="text-3xl text-primary" />, value: '95%', label: 'Satisfaction Rate' },
  ];
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            <span className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white text-sm font-semibold mb-6 border border-white/20">
              <FaPlay className="inline mr-2 text-primary" /> Welcome to the Best Gym
            </span>
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-300">
              Join the best gym in town and start your fitness journey today with expert trainers and modern facilities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register" className="group relative px-8 py-4 bg-gradient-to-r from-orange-500 to-pink-500 rounded-lg font-semibold text-white text-lg overflow-hidden transition-all hover:scale-105 hover:shadow-2xl">
                <span className="relative z-10 flex items-center justify-center">
                  Join Now <FaArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </span>
              ...
              <Link to="/memberships" className="px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-lg font-semibold text-white text-lg hover:bg-white/20 transition-all hover:scale-105">
                Explore Plans
              </Link>
            </div>
          </motion.div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 85C1200 90 1320 90 1380 90L1440 90V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="#0a0a1a"/>
          </svg>
        </div>
      </section>
            ...
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  <div className="flex justify-center mb-3 text-4xl">{stat.icon}</div>
      ...
      {/* Features Section - Premium Gradient */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-xl flex items-center justify-center text-white text-2xl mb-4 group-hover:scale-110 transition-transform`}>
                  {feature.icon}
                </div>
                <h3 className="font-heading text-xl font-bold text-secondary mb-2">{feature.title}</h3>
      ...
      <section className="py-20 bg-[#0a0a1a] relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <Link to="/memberships" className="text-white/80 hover:text-primary font-semibold flex items-center gap-2 group">
              View All Plans <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
            </Link>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {memberships.map((plan, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1, duration: 0.6 }}
                viewport={{ once: true }}
                className={`relative bg-gradient-to-br from-[#12122a] to-[#1a1a3a] rounded-2xl overflow-hidden transition-all hover:-translate-y-2 border ${plan.popular ? 'border-orange-500 shadow-2xl shadow-orange-500/20' : 'border-[#2a2a4a]'}`}
              >
                {plan.popular && (
                ...
                <div className="p-8">
                  ...
                  <Link to={`/memberships?plan=${plan._id}`} className={`mt-8 w-full block text-center px-6 py-3 rounded-lg font-semibold transition-all ${plan.popular ? 'bg-gradient-to-r from-orange-500 to-pink-500 text-white hover:shadow-2xl hover:scale-105' : 'bg-white/10 text-white hover:bg-white/20'} `}>
                    Get Started
                  </Link>
                </div>
              </motion.div>
      ...
      {/* Trainers Section - Premium Light */}
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <Link to="/trainers" className="text-primary font-semibold flex items-center gap-2 group">
              View All Trainers <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
            </Link>
          </motion.div>
            ...
            {trainers.map((trainer, index) => (
              ...
              >
                <div className="relative overflow-hidden">
                  <img src={trainer.image || 'https://images.unsplash.com/photo-1567013127542-490d757e51fc?w=400'} alt={trainer.name} className="w-full h-72 object-cover group-hover:scale-110 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </div>
                <div className="p-6">
                  <h4 className="font-heading text-xl font-bold text-secondary">{trainer.name}</h4>
                  <p className="text-primary text-sm font-semibold">{trainer.specialization}</p>
                  <p className="text-gray-500 text-sm mt-1">{trainer.experience}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <Link to="/classes" className="text-primary font-semibold flex items-center gap-2 group">
              View All Classes <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
            </Link>
          </motion.div>
            ...
            {classes.map((cls, index) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="font-heading text-xl font-bold text-secondary group-hover:text-primary transition-colors">{cls.name}</h4>
                    <span className="inline-block px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-semibold mt-1">{cls.category}</span>
                  </div>
                ...
                <div className="mt-4 space-y-2 text-gray-600 text-sm">
                  <p className="flex items-center"><FaClock className="mr-2 text-primary" /> {cls.startTime} - {cls.endTime}</p>
                  <p className="flex items-center"><FaUsers className="mr-2 text-primary" /> {cls.availableSeats || 0} seats available</p>
                </div>
                {cls.trainer && (
                  <div className="mt-4 flex items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="ml-3">
                      <p className="font-semibold text-secondary text-sm">{cls.trainer.name}</p>
      ...
      {/* Testimonials - Premium Dark with Glow */}
      <section className="py-20 bg-[#0a0a1a] relative overflow-hidden">
        <div className="absolute inset-0">
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex items-center">
                  <img src={testimonial.image} alt={testimonial.name} className="w-12 h-12 rounded-full object-cover border-2 border-orange-500" />
                  <div className="ml-3">
      ...
      {/* CTA Section - Premium Gradient with Animation */}
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            <h2 className="font-heading text-3xl md:text-5xl font-bold text-white mb-4">
              Ready to Start Your <span className="text-yellow-300">Fitness Journey</span>?
            </h2>
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Join our community today and get access to world-class facilities, expert trainers, and a supportive environment.
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <Link to="/register" className="inline-flex items-center px-10 py-4 bg-white text-secondary rounded-lg font-bold text-lg hover:shadow-2xl transition-all">
